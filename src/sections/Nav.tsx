      ...
      <Disclosure as="nav">
        {({open}) => (
            ...
            <div className="flex h-[15vh] max-w-7xl items-center justify-between px-8 lg:px-12 xl:m-auto">
                <div className="flex">
                    <ButtonLink href="#" children={<img src={Paydrop} alt="logo"/>} />
                ...
                <ButtonLink href='#' target="_blank" children={"Contact"} className="active:bg hidden rounded-full bg-gray-800 px-5 py-3 text-white hover:bg-gray-900 active:bg-gray-600 sm:flex" />
